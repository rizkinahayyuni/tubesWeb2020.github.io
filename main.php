    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <img style="margin-top:-15px;margin-right:5px" src="assets/img/logo.png" alt="Logo" height="30px"> 
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2020 - TUGAS BESAR DESAIN & PEMROGRAMAN WEB</strong>
      </footer>
    </div><!-- ./wrapper -->
